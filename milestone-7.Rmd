...
Alice Notes
+ as.factor(region))plm())plm(y ~ x, data = mydata, within = “region”) no stan_glm for conjoint study, hetergeneouos effects, conjoint balance, effect of other attributes compared to one we care about, 

sgtan_glm(voting ~ region*local_thing, data=data)
